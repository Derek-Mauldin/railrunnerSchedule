...
* `git clone git@github.com:rumblex/angularattack2016-knights.git`

* `cd angularattack2016-knights`
...
If you receive an error message `"You do not have permission to publish to knights.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add mylifeassurance@aol.com,mball15@cnm.edu,derek.e.mauldin@gmail.com,kgarrott@cnm.edu`
